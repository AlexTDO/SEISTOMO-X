# src/seistomo/acquisition/source.py
class Ricker:
    """
    Wavelet de Ricker.
    """
    ...
    def __call__(self, t):
        # t é um tensor de tempos
        pi2_f2_t2 = (torch.pi ** 2) * (self.f0 ** 2) * (t ** 2)
        return (1 - 2 * pi2_f2_t2) * torch.exp(-pi2_f2_t2)

import torch # Import necessário para o Ricker
